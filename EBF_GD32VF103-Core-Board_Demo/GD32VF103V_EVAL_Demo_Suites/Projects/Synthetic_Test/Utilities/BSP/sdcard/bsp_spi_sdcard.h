...
/** 
  ...
  */  
#define SD_CS_LOW()     gpio_bit_reset(SD_CS_GPIO_PORT, SD_CS_PIN)
/** 
  * @brief  Deselect SD Card: ChipSelect pin high   
  */ 
#define SD_CS_HIGH()    gpio_bit_set(SD_CS_GPIO_PORT, SD_CS_PIN)
/**
  * @}
  */ 
