...
选择BANK0-BORSRAM1 连接 TFT，地址范围为0X6000 0000 ~ 0X63FF FFFF
EXMC_A16 接LCD的DC(寄存器/数据选择)脚
寄存器基地址 = 0X60000000
RAM基地址 = 0X60020000 = 0X60000000+2^16*2 = 0X60000000 + 0X20000 = 0X60020000
当选择不同的地址线时，地址要重新计算  
****************************************************************************************/

/******************************* ILI9341 显示屏的 EXMC 参数定义 ***************************/
//EXMC_Bank0_NORSRAM用于LCD命令操作的地址
#define	     EXMC_BANK0_BASE		       (0x60000000)
#define      EXMC_Addr_ILI9341_CMD         ( ( uint32_t ) EXMC_BANK0_BASE )

//EXMC_Bank0_NORSRAM用于LCD数据操作的地址      
...
//DC引脚，使用EXMC的地址信号控制，本引脚决定了访问LCD时使用的地址
//PD11为EXMC_A16
...
/*************************************** 调试预用 ******************************************/
#define      DEBUG_DELAY()                delay_1ms(50)     // 需要延时才能初始化成功
