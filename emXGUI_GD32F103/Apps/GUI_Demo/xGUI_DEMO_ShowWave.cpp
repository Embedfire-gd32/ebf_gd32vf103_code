...
#define	COLOR_DESKTOP_BACK_GROUND  50,150,100

#define	GUI_VMEM_Alloc	vmalloc
#define	GUI_VMEM_Free	vfree
static HFONT defaultFont=NULL;
static HFONT controlFont_16=NULL;
static HFONT controlFont_24=NULL;
...
extern "C" void	xGUI_DEMO_ShowWave(void)
{
	HWND hwnd;
	MSG	msg;
	WNDCLASS wcex;
	...
	hwnd	=CreateWindowEx(	WS_EX_NODRAG,&wcex,//WS_EX_FRAMEBUFFER
							L"Show Wave",
							WS_OVERLAPPEDWINDOW,
							rc.x,rc.y,rc.w,rc.h,
							NULL,0,NULL,NULL);
