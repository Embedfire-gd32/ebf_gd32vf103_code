...
static	LRESULT	win_proc(HWND hwnd,UINT msg,WPARAM wParam,LPARAM lParam)
{
	...
	switch(msg)
	{
		case	WM_CREATE:
				...
				wnd=CreateWindow(LISTBOX,_T("Listbox"),LBS_LINE|LBS_NOTIFY|WS_BORDER|WS_VISIBLE,8,8,160,120,hwnd,ID_LISTBOX1,NULL,NULL);
				...
				SendMessage(wnd,LB_SETITEMHEIGHT,3,60);

				////
				wnd=CreateWindow(LISTBOX,_T("Listbox2"),WS_VISIBLE,200,8,180,160,hwnd,ID_LISTBOX2,NULL,NULL);
				...
				wnd=CreateWindow(LISTBOX,_T("Listbox3"),LBS_LINE|WS_BORDER|WS_VISIBLE,8,150,160,100,hwnd,ID_LISTBOX3,NULL,NULL);
...
void	GUI_DEMO_Listbox_Loop(void)
{
		HWND	hwnd;
		WNDCLASS	wcex;
		MSG msg;
